...
module.exports = {
    run: async (msg, args) => {
        ...
        let embed = await validation.card.type(card[0]);
    ...
    options: {
        aliases: [],
        description: "searches for a specific card and returns that card for you.",
        fullDescription: "searches for a specific card and returns that card for you.",
        usage: "(card name)",
